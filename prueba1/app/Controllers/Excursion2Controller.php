...
use App\Models\Excursiondosmodel;

class Excursion2Controller extends BaseController
{
    

    public function calcularExcursionDos(){
...
if($suma_peso<=20 && $suma_calorias>=40){
