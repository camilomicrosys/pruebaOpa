...
use App\Models\Excursionunomodel;

class Excursion1Controller extends BaseController
{
    public function index()
    {


        return view('vistas_excursion/index.php');
    }

    public function calcularExcursionUno(){
        //creamos el objeto de  excursion 1
        $objeto= new Excursionunomodel;
...
if($suma_peso<=15 && $suma_calorias>=20){
